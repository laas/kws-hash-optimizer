...
/**
 * \brief Declaration of EllipticDirectPath.
 */
...
namespace kws
{
  namespace hashoptimizer
  {
    ...
    protected:
      ...
      ktStatus
      init(const EllipticDirectPathWkPtr& inWeakPtr);
...
#endif //! KWS_HASH_OPTIMIZER_ELLIPTIC_DIRECTPATH_HH_
